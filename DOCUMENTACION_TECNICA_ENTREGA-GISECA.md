...
| **Pruebas Automatizadas** | PHPUnit 12.x (156 pruebas automatizadas de integración y features) |
...
- Rendimiento e integridad: kardex, cuentas, reporte CSV, pagos, códigos y KPIs (`RendimientoIntegridadTest.php`).
