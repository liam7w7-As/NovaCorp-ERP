        ...
        @forelse($canales as $canal)
          @php
            ...
            $datosCanal = [
              ...
              'plantilla_nombre' => $canal->plantilla_nombre,
              'plantilla_idioma' => $canal->plantilla_idioma,
              'activo' => $canal->activo,
  ...
  <div class="modal-box">
    ...
    <form id="formCanal" method="POST" action="{{ route('crm.canales.store') }}">
      ...
      <div class="canales-form">
        ...
        <div><label class="form-label-giseca">Plantilla Meta (nombre aprobado)</label><input class="form-control-giseca" id="canal_plantilla_nombre" name="plantilla_nombre" autocomplete="off" placeholder="Ej. seguimiento_cotizacion"></div>
        <div><label class="form-label-giseca">Idioma plantilla</label><input class="form-control-giseca" id="canal_plantilla_idioma" name="plantilla_idioma" autocomplete="off" placeholder="es"></div>
...
function abrirCanal(){document.getElementById('tituloCanal').textContent='Nueva línea comercial';document.getElementById('formCanal').action=@json(route('crm.canales.store'));document.getElementById('metodoCanal').innerHTML='';['nombre','telefono','ciudad','waba_id','phone_number_id','graph_version','access_token','plantilla_nombre','plantilla_idioma'].forEach(c=>document.getElementById('canal_'+c).value='');document.getElementById('canal_activo').checked=true;document.querySelectorAll('[data-vendedor]').forEach(el=>el.checked=false);document.getElementById('modalCanal').classList.add('abierto')}
function editarCanal(canal){document.getElementById('tituloCanal').textContent='Editar línea comercial';document.getElementById('formCanal').action=@json(url('/crm/canales'))+'/'+canal.id;document.getElementById('metodoCanal').innerHTML='<input type="hidden" name="_method" value="PUT">';document.getElementById('canal_nombre').value=canal.nombre||'';document.getElementById('canal_telefono').value=canal.telefono||'';document.getElementById('canal_ciudad').value=canal.ciudad||'';document.getElementById('canal_waba_id').value=canal.waba_id||'';document.getElementById('canal_phone_number_id').value=canal.phone_number_id||'';document.getElementById('canal_graph_version').value=canal.graph_version||'';document.getElementById('canal_plantilla_nombre').value=canal.plantilla_nombre||'';document.getElementById('canal_plantilla_idioma').value=canal.plantilla_idioma||'';document.getElementById('canal_access_token').value='';document.getElementById('canal_activo').checked=Boolean(canal.activo);document.querySelectorAll('[data-vendedor]').forEach(el=>el.checked=canal.vendedores.includes(Number(el.value)));document.getElementById('modalCanal').classList.add('abierto')}
